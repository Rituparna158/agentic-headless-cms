...
const Spacer = React.forwardRef<HTMLDivElement, SpacerProps>(
  (
    ...
    if (responsive) {
      if (
        responsive.mobile &&
        designTokenSizes.includes(responsive.mobile as string)
      ) {
        responsiveClasses.push(
          spacerVariants({
            size: responsive.mobile as SpacerVariantSize,
            direction,
          }),
        );
      }
      if (
        responsive.tablet &&
        designTokenSizes.includes(responsive.tablet as string)
      ) {
        responsiveClasses.push(
      ...
      if (
        responsive.desktop &&
        designTokenSizes.includes(responsive.desktop as string)
      ) {
        responsiveClasses.push(
    ...
    return (
      <div
        ...
        className={cn(
          !isCustomSize &&
            spacerVariants({ size: size as SpacerVariantSize, direction }),
          responsiveClasses,
          className,
        )}
        style={dynamicStyle}
